...
// Para poder tener un diseño adecuado en cada plataforma, descargué este paquete de este sitio web:
// https://www.npmjs.com/package/react-native-responsive-screen
import {widthPercentageToDP as wp, heightPercentageToDP as hp} from 'react-native-responsive-screen';

/**
 * la lista completa de estilos para toda la aplicación, esto solo se hace para una buena organización, de modo que todos los estilos estén en un solo
 * lugar y sean fáciles de encontrar.
 * Usé la convención para nombrar los estilos como screennameSTYLENAME de modo que incluso si este archivo fuera un poco complicado, uno puede encontrar
 * los estilos en uso y en qué pantalla los usa.
 * Observación: hay algunos estilos que no están en uso en la versión final de la aplicación, pero la mayoría sí.
 */
const styles = StyleSheet.create({

    // anyStyles para la reutilización en varias pantallas
    // #################################################################################################################
    anyWholeScreen: {
        backgroundColor: '#fff',
        width: wp("100%"),
