            ...
            return (
                <View style={styles.anyWholeScreen}>
                    ...
                    <View style={styles.howToBadgersContainer}>
                        <Image source={require('../assets/images/badgerHowTo.png')}
                               style={styles.howToBadgerImageStyle}/>
                    </View>
            ...
            return (
                <View style={styles.anyWholeScreen}>
                    ...
                    <View style={styles.howToTextContainer}>
                        ...
                        <WebView source={{
                            html: "<html><p style='text-align: justify; color:rgba(96,100,109, 1); font-size:6vw;'>" +
                                QuestionSheet.getInfo(0) +
                                "</p></html>"
                        }}
            ...
            <View style={styles.howToBottomContainer}>
                ...
                <View style={styles.howToAudioContainer}>
                    <TouchableHighlight onPress={() => {
                        AudioFile.audioFunction('HowTo', 'play')
                    }} underlayColor="rgba(96,100,109, 1)" style={styles.howToButtonAudioStyle}>
                    ...
                    <TouchableHighlight onPress={() => {
                        AudioFile.audioFunction('HowTo', 'stop')
                    }} underlayColor="rgba(96,100,109, 1)" style={styles.howToButtonAudioStyle}>
                ...
                <View style={styles.howToNextScreenContainer}>
                    <TouchableHighlight onPress={() => {
                        ...
                        <Text style={styles.howToBackButtonText}>Volver </Text>
                    </TouchableHighlight>
                    <TouchableHighlight onPress={() => {
                        if (AudioFile.getAudioStatus('HowTo')) {
                            AudioFile.audioFunction('HowTo', 'pause');
