...
/**
 * IDEA:
 * this screen shows the 9th task of the quiz with solution
 */
export default class SubmittedStation9Screen extends React.Component {
  static navigationOptions = {
    title: "SubmittedStation9Screen", // set a title for the navigation bar at the top and the design is in the file ../navigation/StackNavigator.js   
    header: null,
  };
  ...
  constructor(props) {
    super(props);
    this.state = { 
        chosenAnswerStation9: AnswerSheet.getAnswer(9),
        rightAnswerStation9: AnswerSheet.getRightAnswer(9),
    };
  };
