...
/**
 * IDEA:
 * this screen shows the 4th info text of the quiz
 */
    ...
    if(Platform.OS === 'ios'){
      return (      
        <View style={styles.anyWholeScreen}>
          ...
          <Image source={require('../assets/images/foxStation1Info.png')} style={styles.station4InfoImageStyle}/>
        ...
        <View style={styles.anyWholeScreen}>
          ...
          <View style={styles.stationInfoTextContainer}>
            {/*fontsize in css for right size according to the screenheight use: https://stackoverflow.com/questions/16056591/font-scaling-based-on-width-of-container */}
              <Image
                  source={require('../assets/images/imageInfo2.png')}
    ...
    return(
      <View style={styles.stationInfoBottomContainer}>
        ...
        <View style={styles.stationInfoAudioContainer}>
            <TouchableHighlight onPress={() => {AudioFile.audioFunction('Station4Info','play',false)}} underlayColor="rgba(96,100,109, 1)" style={styles.stationInfoButtonAudioStyle}>
              <IconMaterialCommunityIcons name='play-circle-outline' size={hp('7%')} color='#C92732'/>
            </TouchableHighlight>
            <TouchableHighlight onPress={() => {AudioFile.audioFunction('Station4Info','pause',true)}} underlayColor="rgba(96,100,109, 1)" style={styles.stationInfoButtonAudioStyle}>
              <IconMaterialCommunityIcons name='pause-circle-outline' size={hp('7%')} color='#C92732'/>
            </TouchableHighlight>
            <TouchableHighlight onPress={() => {AudioFile.audioFunction('Station4Info','stop',false)}} underlayColor="rgba(96,100,109, 1)" style={styles.stationInfoButtonAudioStyle}>
        ...
        */}    
        ...
        <TouchableHighlight onPress={() => {
                if(AudioFile.getAudioStatus('Station4Info')){
                  AudioFile.audioFunction('Station4Info','pause');
          ...
          <TouchableHighlight onPress={() => {
                  if(AudioFile.getAudioStatus('Station4Info')){
                    AudioFile.audioFunction('Station4Info','pause');
                    if(this.props.navigation.getParam('originScreenName')==='Result'){
                      this.props.navigation.navigate('SubmittedStation4');
                    }
                    else{
