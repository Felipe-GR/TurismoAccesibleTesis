...
/**
 * IDEA:
 * this screen shows the 6th info text of the quiz
 */
export default class Station6Screen extends React.Component {
    static navigationOptions = {
        title: "Station6Screen", // set a title for the navigation bar at the top and the design is in the file ../navigation/StackNavigator.js
    };
            ...
            return (
                <View style={styles.anyWholeScreen}>
                    ...
                    <View style={styles.station1InfoFoxContainer}>
                        <Image source={require('../assets/images/foxStation1Info.png')}
                               style={styles.station1InfoFoxImageStyle}/>
                    </View>
            ...
            return (
                <View style={styles.anyWholeScreen}>
                    ...
                    <View style={styles.stationInfoTextContainer}>
                        ...
                        <WebView source={{
                            html: "<html>" +
                                "<p style='text-align: justify; color:rgba(96,100,109, 1); font-size:6vw;'>" +
                                QuestionSheet.getInfo(1) +
                                "</p></html>"
                        }}
            ...
            <View style={styles.stationInfoBottomContainer}>
                ...
                <View style={styles.stationInfoAudioContainer}>
                    <TouchableHighlight onPress={() => {
                        AudioFile.audioFunction('Station1Info', 'play')
                    }} underlayColor="rgba(96,100,109, 1)" style={styles.stationInfoButtonAudioStyle}>
                    ...
                    <TouchableHighlight onPress={() => {
                        AudioFile.audioFunction('Station1Info', 'stop')
                    }} underlayColor="rgba(96,100,109, 1)" style={styles.stationInfoButtonAudioStyle}>
